                ...
                <div class="modal-body">
                    <form method="post" id="form-mahasiswa" name="form-mahasiswa" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <label id="cekemail" class="text-danger" style="display: none;">Bukan Email
                                Institusi</label>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function (id, dosen_nama) {
                    $('select[name="dosen_id"]').append('<option value="' + id + '">' +
                        dosen_nama + '</option>');
                });
            }
        });
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function (id, angkatan_tahun) {
                    $('select[name="angkatan_id"]').append('<option value="' + id + '">' +
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function (id, prodi_nama) {
                    $('select[name="prodi_id"]').append('<option value="' + id + '">' +
                        prodi_nama + '</option>');
                });
            }
        });
