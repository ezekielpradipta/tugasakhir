                ...
                <div class="modal-body">
                    <form method="post" id="formSlider" name="formSlider" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           ...
                           <textarea name="slider_caption" id="slider_caption" class="form-control" cols="30" rows="5"></textarea>
                            
                        </div>
                        <div class="form-group">
                            <label for="">Urut</label>
                            <input type="text" id="slider_order" class="form-control" name="slider_order" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
                        </div>
                    </form>
                </div>
...
<script>
    $(document).ready( function () {
            ...
            var table = $('#dt').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.slider.inputtak') }}",
                columns: [
            ...
            $('body').on('click', '.btn-edit', function () {
                ...
                var url = "{{route('admin.slider.inputtak')}}".concat("/" + slider_id +"/edit");
                console.log(url);
                jQuery.ajax({
                     url :  url,
                     type : "GET",
