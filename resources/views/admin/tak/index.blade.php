                    ...
                    <form method="post" id="formTak" name="formTak" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-sm-2 ">
                                    <a href="javascript:void(0)" id="kategoritak-tambah"
                                        data-toggle="modaltambahkategori" class="btn btn-primary btn-sm">
                                        <span class="fas fa-plus"></span>
                                    </a>
                                    <a href="javascript:void(0)" id="kategoritak-data"
                                        data-toggle="modal-kategori-tambah" class="btn btn-secondary btn-sm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-sm-2 ">
                                    <a href="javascript:void(0)" id="pilartak-tambah" data-toggle="modal-pilar-tambah"
                                        class="btn btn-primary btn-sm">
                                        <span class="fas fa-plus"></span>
                                    </a>
                                    <a href="javascript:void(0)" id="pilartak-data" data-toggle="modal-pilar-data"
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-sm-2 ">
                                    <a href="javascript:void(0)" id="kegiatantak-tambah"
                                        data-toggle="modal-kegiatan-data" class="btn btn-primary btn-sm">
                                        <span class="fas fa-plus"></span>
                                    </a>
                                    <a href="javascript:void(0)" id="kegiatantak-data" data-toggle="modal-kegiatan-data"
                                        class="btn btn-secondary btn-sm">
                                        <span class="fas fa-cog"></span>
                                    </a>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-sm-2 ">
                                    <a href="javascript:void(0)" id="partisipasitak-tambah"
                                        data-toggle="modal-partisipasi-tambah" class="btn btn-primary btn-sm">
                                        <span class="fas fa-plus"></span>
                                    </a>
                                    <a href="javascript:void(0)" id="partisipasitak-data"
                                        data-toggle="modal-partisipasi-data" class="btn btn-secondary btn-sm">
                                        <span class="fas fa-cog"></span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tak_score" class="form-control" id="tak_score"
                                placeholder="Skor Tak">
    ...
    <div class="modal hide fade" id="modal-kategori-tambah">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="form-kategori-tambah" name="form-kategori-tambah"
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <input type="text" name="kategoritak_nama" class="form-control" id="kategoritak_nama"
                                    placeholder="Nama Kategori">
                                <label id="kategoritersedia" class=" text-success " style="display:none">Kategori
                                    Tersedia</label>
                                <label id="kategoritidaktersedia" class="text-danger" style="display:none">Kategori
                    ...
                    <form method="post" id="form-pilar-tambah" name="form-pilar-tambah" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="pilartak_nama" class="form-control" id="pilartak_nama"
    ...
    <div class="modal hide fade" id="modal-kegiatan-tambah">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="form-kegiatan-tambah" name="form-kegiatan-tambah"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="alert alert-danger" style="display:none"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kegiatantak_nama" class="form-control" id="kegiatantak_nama"
    ...
    <div class="modal hide fade" id="modal-partisipasi-tambah">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="form-partisipasi-tambah" name="form-partisipasi-tambah"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="alert alert-danger" style="display:none"></div>
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <select name="partisipasi_kegiatan" id="partisipasi_kegiatan" class="form-control"
                                    required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="partisipasitak_nama" class="form-control"
                                    id="partisipasitak_nama" placeholder="Nama Partisipasi">
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" value="tambah" id="save-partisipasi">Save
                        data</button>
                </div>
            </div>
        </div>
    ...
    $(document).ready(function () {
        ...
        var tbTak = $('#tbTak').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'kegiatantak.kegiatantak_nama',
                    name: 'kegiatantak.kegiatantak_nama'
                },

                {
                    data: 'partisipasitak.partisipasitak_nama',
                    name: 'partisipasitak.partisipasitak_nama'
                },
                {
                    data: 'tak_score',
                    name: 'tak_score'
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (id, kategoritak_nama) {
                        $('select[name="kategoritak"]').append('<option value="' +
                            id + '">' + kategoritak_nama + '</option>');
                    });
                }
            });
        });
        ...
        $('#kategoritak').change(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('select[name="pilartak"]').append(
                        '<option selected disabled value="">--Pilih Pilar TAK--</option>'
                        );
                    $('select[name="kegiatantak"]').empty();
                    $('select[name="kegiatantak"]').append(
                        '<option selected disabled value="">--Pilih Kegiatan TAK--</option>'
                        );
                    $('select[name="partisipasitak"]').empty();
                    $('select[name="partisipasitak"]').append(
                        '<option selected disabled value="">--Pilih Partisipasi TAK--</option>'
                        );

                    $.each(data, function (id, pilartak_nama) {
                        $('select[name="pilartak"]').append('<option value="' + id +
                            '">' + pilartak_nama + '</option>');
                    });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (id, kegiatantak_nama) {
                        $('select[name="kegiatantak"]').append('<option value="' +
                            id + '">' + kegiatantak_nama + '</option>');
                    });
        ...
        $('#save-kategori').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    Command: swal("Sukses", "Berhasil menambahkan Data Kategori TAK",
                        "success");
                    pilar_kategori = true;
        ...
        var tbKategori = $('#tbKategori').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'kategoritak_nama',
                    name: 'kategoritak_nama'
                },
                {
                    data: 'action',
                    name: 'action',
            ...
            if (pilar_kategori) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('select[name="pilar_kategori"]').append(
                            '<option selected disabled value="">--Pilih Kategori TAK--</option>'
                            );
                        $.each(data, function (id, kategoritak_nama) {
                            $('select[name="pilar_kategori"]').append(
                                '<option value="' + id + '">' +
        ...
        $('#pilar_kategori').ready(function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (id, kategoritak_nama) {
                        $('select[name="pilar_kategori"]').append(
                            '<option value="' + id + '">' + kategoritak_nama +
                            '</option>');
                    });
        ...
        $('#save-pilar').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    Command: swal("Sukses", "Berhasil menambahkan Data Pilar TAK",
                        "success");
                    pilar_kategori = true;
        ...
        var tbPilar = $('#tbPilar').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'kategoritak.kategoritak_nama',
                    name: 'kategoritak_nama'
                },
                {
                    data: 'pilartak_nama',
        ...
        var tbKegiatan = $('#tbKegiatan').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'kegiatantak_nama',
                    name: 'kegiatantak_nama'
                },
                {
                    data: 'action',
                    name: 'action',
            ...
            if (kegiatan_kategori) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('select[name="kegiatan_kategori"]').append(
                            '<option selected disabled value="">--Pilih Kategori TAK--</option>'
                            );
                        $.each(data, function (id, kategoritak_nama) {
                            $('select[name="kegiatan_kategori"]').append(
        ...
        $('#kegiatan_pilar').ready(function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (id, pilartak_nama) {
                        $('select[name="kegiatan_pilar"]').append(
                            '<option value="' + id + '">' + pilartak_nama +
                            '</option>');
                    });
        ...
        $('#kegiatan_pilar').click(function () {
            ...
            var urlcoba = "{{route('tak.get.pilar.id')}}".concat("/" + kegiatan_kategori);
        ...
        $('#kegiatan_kategori').change(function () {
            ...
            if (kegiatan_kategori) {
                var url = "{{route('tak.get.pilar.id')}}".concat("/" + kegiatan_kategori);
        ...
        $('#save-kegiatan').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    Command: swal("Sukses", "Berhasil menambahkan Data Kegiatan TAK",
                        "success");
                    pilar_kategori = true;
        ...
        var tbPartisipasi = $('#tbPartisipasi').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'partisipasitak_nama',
                    name: 'partisipasitak_nama'
                },
                {
                    data: 'action',
                    name: 'action',
            ...
            if (partisipasi_kegiatan) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('select[name="partisipasi_kegiatan"]').append(
                            '<option selected disabled value="">--Pilih Kegiatan TAK--</option>'
                            );
                        $.each(data, function (id, kegiatantak_nama) {
                            $('select[name="partisipasi_kegiatan"]').append(
                                '<option value="' + id + '">' +
                                kegiatantak_nama + '</option>');
                        });
        ...
        $('#partisipasi_kegiatan').ready(function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (id, kegiatantak_nama) {
                        $('select[name="partisipasi_kegiatan"]').append(
                            '<option value="' + id + '">' + kegiatantak_nama +
                            '</option>');
                    });
        ...
        $('#save-partisipasi').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    Command: swal("Sukses", "Berhasil menambahkan Data Partisipasi TAK",
                        "success");
                    pilar_kategori = true;
                ...
                error: function (data) {
                    ...
                    Command: swal("Gagal", "Gagal menambahkan Data Kegiatan TAK", "error");
                    $('#kegiatan_pilarError').text(data.responseJSON.errors.pilartak_id);
                    $('#partisipasiNamaError').text(data.responseJSON.errors
                        .partisipasitak_nama);
                    $('#save-kegiatan').html('Save Changes');
                }
            });
