                ...
                <form method="post" id="formTak" name="formTak" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="penyelenggara" class="form-control" id="penyelenggara"
                            placeholder="Penyelenggara" disabled>
                        <label class="text-danger" id="tak_scoreError"></label>
                    </div>
                    <div class="form-group">
...
<script>
    $(document).ready( function () {
        var table = $('#dt').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('dosen.validasi.index') }}",
                    data: function (d) {
                      d.status = $('#status').val() 
            ...
            $('body').on('click','.btn-show',function(){
              ...
              var url = "{{route('dosen.daftarmahasiswa.index')}}".concat("/" + mahasiswa_id +"/edit");
            ...
            $('body').on('click','.btn-cek',function(){
                var inputtak_id = $(this).data('id');
              var url = "{{route('dosen.validasi.index')}}".concat("/" + inputtak_id +"/cek");
              console.log(url);
              swal({
