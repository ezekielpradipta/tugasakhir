...
<script>
	$(document).ready(function(){
			var table = $('#dt').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('dosen.daftartak.index') }}",
                columns: [
			...
			$('body').on('click','.show-Bukti',function(){
              ...
              var url = "{{route('dosen.daftartak.index')}}".concat("/" + inputtak_id +"/bukti");
              console.log(url);
              jQuery.ajax({
                     url :  url,
                     type : "GET",
			...
			$('body').on('click','.btn-unduh',function(){
              ...
              var url = "{{route('dosen.daftartak.index')}}".concat("/" + inputtak_id +"/cetakBukti");
              console.log(url);
              $.ajax({
                      url: url,
                      type: 'GET',
			...
			$('body').on('click','.btn-status',function(){
              var inputtak_id = $(this).data('id');
              var url = "{{route('dosen.daftartak.index')}}".concat("/" + inputtak_id +"/status");
              console.log(url);
              swal({
			...
			$('body').on('click', '.btn-edit', function () {
                var inputtak_id = $(this).data('id');
                var url = "{{route('dosen.daftartak.index')}}".concat("/" + inputtak_id +"/edit");
                console.log(url);
                jQuery.ajax({
                     url :  url,
                     type : "GET",
