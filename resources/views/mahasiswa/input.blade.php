                ...
                <table class="table table-borderless">
                  <tbody>
                    <tr>
                      ...
                      <td><a href="#" class=" btn btn-danger remove"><i class="fa fa-minus" aria-hidden="true"></i></a>
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-10">
                    <input type="text" name="namaindo"
                      placeholder="Contoh : ATVSI Peduli - Seminar Jurnalistik Dan Produksi Kreatif " id="namaindo"
                      class="form-control">
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-10">
                    <input type="text" name="namainggris"
                      placeholder="Contoh : Seminar of Journalism And Creative Production " id="namainggris"
                      class="form-control">
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-10">
                    <input type="text" name="penyelenggara" placeholder="Nama Penyelenggara Kegiatan Tersebut"
                      id="penyelenggara" class="form-control">
                  </div>
                </div>
                <div class="form-group row">
  ...
  $(document).ready(function () {
        ...
        $('#btn-save').click(function (e) {
            ...
            $.ajax({
                ...
                url: "{{ route('mahasiswa.inputtak.store') }}",
                type: "POST",
                ...
                error: function (data) {
                    ...
                    $("#error").show();
                    var error_penyelenggara = data.responseJSON.errors.penyelenggara;
                    if (error_penyelenggara) {
                        for (var i = 0; i < error_penyelenggara.length; i++) {
                            var obj = '<li>' + error_penyelenggara[i] + '</li>';
                            $('.list_error').append(obj);
                        }
                    }
                    var tahunajaran = data.responseJSON.errors.tahunajaran;
                    if (tahunajaran) {
                        for (var k = 0; k < tahunajaran.length; k++) {
                            var obj2 = '<li>' + tahunajaran[k] + '</li>';
                            $('.list_error').append(obj2);
                        }
                    }
                    var tanggalawal = data.responseJSON.errors.tanggalawal;
                    if (tanggalawal) {
                        for (var k = 0; k < tanggalawal.length; k++) {
                            var obj3 = '<li>' + tanggalawal[k] + '</li>';
                            $('.list_error').append(obj3);
                        }
                    }
                    var tanggalakhir = data.responseJSON.errors.tanggalakhir;
                    if (tanggalakhir) {
                        for (var k = 0; k < tanggalakhir.length; k++) {
                            var obj4 = '<li>' + tanggalakhir[k] + '</li>';
                            $('.list_error').append(obj4);
                        }
                    }
                    var namaindo = data.responseJSON.errors.namaindo;
                    if (namaindo) {
                        for (var k = 0; k < namaindo.length; k++) {
                            var obj5 = '<li>' + namaindo[k] + '</li>';
                            $('.list_error').append(obj5);
                        }
                    }
                    var namainggris = data.responseJSON.errors.namainggris;
                    if (namainggris) {
                        for (var k = 0; k < namainggris.length; k++) {
                            var obj6 = '<li>' + namainggris[k] + '</li>';
                            $('.list_error').append(obj6);
                        }
                    }
